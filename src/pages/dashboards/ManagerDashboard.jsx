...
export default function ManagerDashboard({ user, onLogout, transactions, categories, loans, inventory, fetchData }) {
    ...
    try {
      ...
      const { data: orderData, error: orderErr } = await supabase
        ...
        .insert({
          ...
          assigned_to: user.username, // Assign to current CEO/CFO by default, or could be unassigned
